...
export BUILD_NAME=CREATABLE_Edition_16.07.27
...
if [ "$BUILD_TARGET" = "darwin" ]; then
 ...
 #    if [ $? != 0 ]; then echo "Failed to clone CuraEngine"; exit 1; fi
	...
	hdiutil detach /Volumes/Cura\ -\ Creatable/
	...
	cp -a dist/Cura.app /Volumes/Cura\ -\ Creatable/Cura/
	hdiutil detach /Volumes/Cura\ -\ Creatable
