...
class MachineSelectPage(InfoPage):
	def __init__(self, parent):
		...
		self.CreatableD2Radio = self.AddRadioButton("CREATABLE D2", style=wx.RB_GROUP)
		self.CreatableD2Radio.Bind(wx.EVT_RADIOBUTTON, self.OnCreatableSelect)
		self.CreatableD2Radio.SetValue(True)
	...
	def StoreData(self):
		...
		if self.Ultimaker2Radio.GetValue() or self.Ultimaker2GoRadio.GetValue() or self.Ultimaker2ExtRadio.GetValue():
			...
			if self.CreatableD2Radio.GetValue():
				...
				profile.putMachineSetting('machine_height', '165')
				profile.putMachineSetting('machine_name', 'Creatable D2')
				profile.putMachineSetting('machine_type', 'creatable')
			...
			profile.putProfileSetting('wall_thickness','0.6')
			profile.putProfileSetting('retraction_enable','True')
...
class CreatableReadyPage(InfoPage):
	def __init__(self, parent):
		super(CreatableReadyPage, self).__init__(parent, _("Creatable D2"))
