...
setting('travel_speed',            150.0, float, 'advanced', _('Speed')).setRange(0.1).setLabel(_("Travel speed (mm/s)"), _("Speed at which travel moves are done, a well built CREATABLE D2 can reach speeds of 250mm/s. But some machines might miss steps then."))
...
setting('start.gcode', """;This Gcode has been generated specifically for the Creatable D2
